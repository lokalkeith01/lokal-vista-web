...
const GRAFANA_PANELS: GrafanaPanel[] = [
  ...
  {
    title: "Storage Usage",
    embedUrl: "https://lokalkeith01.grafana.net/d-solo/metrics-endpoint-overview/metrics-endpoint-overview?orgId=1&from=now%2Fd&to=now&timezone=browser&var-datasource=default&var-scrape_job=$__all&var-job=$__all&refresh=30s&panelId=panel-10&__feature.dashboardScene=true",
    height: 300,
  },
  {
    title: "Auth Events",
